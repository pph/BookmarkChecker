...
public interface BookmarkWriter {
    ...
    void open(File file);
    /**
     * Exports all Bookmarks to a (file) target.
     * 
     * @param list a list of Bookmarks that should be exported
     */
    void write(List<Bookmark> list);
    
    /**
     * Closes the target export file
     */
    void close();
}
